  ...
  return (
    <>
      <main className="min-h-screen bg-gray-50">
        ...
        {/* ── Search & Filter Bar ─────────────────────────── */}
        {/* data-seller-view-ok: a signed-in seller "visiting" the buyer
            portal (see sellers/components/SellerViewOnlyGuard.tsx) is still
            allowed to browse — search, sort, and category filters here are
            pure exploration, not a buyer action, so they're exempted from
            the click guard that pops the "you're a seller" modal. */}
        <div data-seller-view-ok className="sticky top-16 z-30 bg-white border-b border-gray-100 shadow-sm">
