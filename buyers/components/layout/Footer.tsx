...
export function Footer() {
  // A signed-in seller can end up here while "visiting" the buyer portal
  // (see sellers/components/SellerViewOnlyGuard.tsx) — pitching them on
  // becoming a seller when they already are one doesn't make sense, so the
  // band is buyer-only.
  const { user } = useUser();
